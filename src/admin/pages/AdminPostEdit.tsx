                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="bg-white rounded shadow-sm border border-gray-200 overflow-hidden">
                        <div className="p-4 border-b border-gray-100 bg-gray-50">
                            <h3 className="text-sm font-bold text-gray-700">Publish Info</h3>
                        </div>
                        <div className="p-4 space-y-4 text-xs text-gray-600">
                            ...
                            <div className="pt-2">
                                ...
                                <p><strong>Created:</strong> {new Date(formData.createdAt).toLocaleString('pt-BR')}</p>
                                <p><strong>Last Update:</strong> {new Date(formData.updatedAt).toLocaleString('pt-BR')}</p>
                                {formData.publishedAt && (
                                    <p><strong>Published:</strong> {new Date(formData.publishedAt).toLocaleString('pt-BR')}</p>
                                )}
                            </div>
                        </div>
